...
<script>
    ...
    <div class="container p-0">
          ...
          <div class="mt-5">
              <span style="font-size: 24px">찜한 여행일정(${putScheduleNum })</span>
          </div>

          <!--클릭한거에 따라 색깔지정 잘해라!!-->
          <div class="mt-4">
              <a href="${path }/mySchedule/putScheduleList.do?userId=${userLoggedIn.userId}" style="text-decoration:none !important;"><span style="font-size: 16px; color: black;">찜한 여행일정(${putScheduleNum })</span></a>
              <span style="font-size: 16px; color: #d4cfcf;" class="ml-3 mr-3">l </span>
              <a href="${path }/mySchedule/putPlaceList.do?userId=${userLoggedIn.userId}" style="text-decoration:none !important;"><span style="font-size: 16px; color: #959595;">찜한 여행지(${putPlaceNum })</span></a>
